...
**Status**: [x] complete
**Priority**: Cu
**Gap detected**: Yod is named and understood (operator, yeoman/purser, radar) but has no formal document or implementation. Yod manages the Queue but doesn't exist as an entity yet.
